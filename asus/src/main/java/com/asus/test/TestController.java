...
public class TestController {
	...
	@RequestMapping(value = "/xdm/test/publicCorona1JsonNodeList")
	public String publicCorona1JsonNodeList(Model model) throws Exception {
		
		String apiUrl = "http://apis.data.go.kr/1471000/CovidDagnsRgntProdExprtStusService/getMmCovidDagnsRgntExprtStusInq?serviceKey=8gd1kkiR6XRtcjwY296bxRIbn8UsKc2FBM%2BdkE2exMfqW8f9hFUtxgqohzk4vohPEtso7hPHaORAZkFsJhnDeg%3D%3D&type=json";
